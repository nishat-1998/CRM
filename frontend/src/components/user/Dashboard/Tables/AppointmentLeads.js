...
const AppointmentLeads = (props) => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      const response = await axios.get(`http://161.97.79.224:3001/dashboard/appointment/leads`);
  ...
  return (
    <>
      <Card {...props} >
        <CardHeader title="Appointment - Leads" style={{ textAlign: 'center' }} />
        <Divider />
        <PerfectScrollbar>
