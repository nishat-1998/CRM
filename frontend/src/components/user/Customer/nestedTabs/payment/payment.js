...
export default function BasicTable(props) {
  ...
  const getInvoiceData = () =>{
    Axios.get("http://161.97.79.224:3001/payment/getPayment",{
        params:{
...
React.useEffect(()=>{
  ...
  return (
      <div>
          <Button style={{marginBottom:20}} color="primary" onClick={()=>{setOpen(!open)}} startIcon={<AddCircleIcon/>}>Add Payment</Button>
          {open?<AddPayment customerId={customerId}/>:<></>}
