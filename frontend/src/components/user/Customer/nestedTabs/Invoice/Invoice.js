...
export default function BasicTable(props) {
  ...
  const getInvoiceData = () =>{
    Axios.get("http://161.97.79.224:3001/invoice/getInvoice",{
        params:{
...
React.useEffect(()=>{
  ...
  return (
      <div>
          <Button style={{marginBottom:20}} color="primary" onClick={()=>{setOpen(!open)}} startIcon={<AddCircleIcon/>}>Add Invoice</Button>
          {open?<AddInvoice customerId={customerId}/>:<></>}
