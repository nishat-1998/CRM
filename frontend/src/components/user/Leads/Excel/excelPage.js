...
import { Table, Button, Popconfirm, Row, Col,Upload,Icon } from "antd";
...
export default class ExcelPage extends Component {
  ...
  handleSubmit = async () => {
//Adding bulk leads detail
    console.log("submitting: ", this.state.rows);
    Axios.post("http://161.97.79.224:3001/AddBulkleads",{
     leadData:this.state.rows,
