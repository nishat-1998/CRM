...
import {Grid,Button,IconButton,MenuItem,TextField,Table,TableBody,TableCell,TableContainer,TableHead,TableRow,Typography,Paper,Link} from '@material-ui/core';
...
function Row(props) {
  ...
  const update= (idmanager)=>{
    //Refer manager.js in routes folder in backend 
    console.log(country)
    Axios.put("http://161.97.79.224:3001/updatemanager",{
      name: name,
      contact:contact,
      mail:mail,
      ssid:SSID,
   ...
   //Refer manager.js in routes folder in backend 
  //Delete  deatils using delete Icon Button
  const Delete = (idmanager)=>{
    if (window.confirm("Are you sure you want to delete?")) {
    Axios.put("http://161.97.79.224:3001/deletemanager",{
           ...
           <>
             ...
             <TextField  id="Name"
              ...
              />       
               ...
               <StyledTableCell align="center">
               <IconButton onClick={()=>{Delete(row.idmanager)}} >
           <DeleteIcon/>
         </IconButton>
         </StyledTableCell>
         <StyledTableCell align="center">
         {editable?<IconButton onClick={()=>{update(row.idmanager)}}  >
           <CheckIcon/>
         </IconButton>:
...
export default function CollapsibleTable() {
  ...
  return (
    <div>
       <Helmet>
      <title>Manager | Custom Relationship Management</title>
    </Helmet>
        <Button variant="contained" color="primary" className={classes.submit} startIcon={<GetAppIcon/>}>
      <CSVLink  style={{color:'#fff'}} data={row} headers={headers}  filename={"manager_report.csv"}>Export</CSVLink>
      </Button>
      <Grid  container
        direction="column"
        justify="center"
    ...
    <Typography style={{margin:10}} variant="h6" color="primary" component="h2">Managers Table</Typography> 
